class NotificationMailer < ApplicationMailer
  ...
  def comment_to_user_mail(comment)
    ...
    mail to: "kei.kamiguchi517@gmail.com", subject: "#{@comment.admin.name}から返事が届いています！"
  end
  ...
  def comment_to_admin_mail(comment)
    ...
    mail to: "kei.kamiguchi517@gmail.com", subject: "#{@comment.user.name}から質問または返事が届いています！"
  end
